...
namespace Cinar.SQLParser
{
    public class Parser
    {
        ...
        public Statement ReadNextStatement()
        {
            ...
            if (fCurrentToken.Value == "update")
                return ParseUpdateStatement();

            if (fCurrentToken.Value == "delete")
                return ParseDeleteStatement();

            if (fCurrentToken.Value == "create")
        ...
        SelectStatement ParseSelectStatement()
        {
            ...
            //   select *,max(id),id 
            //   from table1 as t1
            //        left join table2 as t2 on t1.Falan = t2.Filan
            //   where
            //        t1.Fülan > 12 || t2.Felan ~ 'A%'
            //   group by 1, t1.felan
            //   having x = 1
            //   order by t1.Felan, t2.Fülan desc, t1.x asc, 3
            //   limit x offset y
