...
namespace org.w3c.dom.ls
{
     ...
     * <code>DOMImplementation</code> interface or, if the <code>IDocument</code> 
     * supports the feature <code>"Core"</code> version <code>"3.0"</code> 
     * defined in , by using the method <code>INode.getInterface</code> with 
    ...
    public interface IDOMImplementationLS
    {
         ...
         *   language used during the load of a <code>IDocument</code> using the 
        ...
        /**
         *  Create a new "empty" <code>IDOMInputSource</code>. 
         * @return  The newly created <code>IDOMInputSource</code> object. 
         */
