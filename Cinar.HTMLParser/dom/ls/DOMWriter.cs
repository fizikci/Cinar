...
namespace org.w3c.dom.ls
{
     ...
     * URI. If the <code>namespaceURI</code> of a <code>INode</code> is empty 
     ...
     * nodes of type <code>IDocument</code> or <code>Entity</code>, well formed 
     ...
     * <p>Within a IDocument, DocumentFragment, or Entity being serialized, Nodes 
     ...
     * implementations.  Using these features does affect the <code>INode</code> 
     ...
     * <dd> This feature is equivalent to the one 
     * provided on <code>IDocument.setNormalizationFeature</code> in . Unlike in 
    ...
    public interface IDOMWriter
    {
         ...
         * the node from the stream or to terminate the serialization early. 
         */
        //void setFilter(IDOMWriterFilter filter);
         ...
         * <code>DOMWriter</code>. Writing a IDocument or Entity node produces a 
         ...
         * @param wnode The <code>IDocument</code> or <code>Entity</code> node to 
