...
namespace org.w3c.dom.ls
{
     ...
     * attribute on <code>IElement</code> node represents the property 
     ...
     * <code>IDocument.setNormalizationFeature</code> in . </dd>
     * <dt>
     * <code>"cdata-sections"</code></dt>
     * <dd> This feature is equivalent to the one 
     * provided on <code>IDocument.setNormalizationFeature</code> in . </dd>
     * <dt>
     ...
     * Explicitly setting an encoding in the <code>IDOMInputSource</code> 
     ...
     * one provided on <code>IDocument.setNormalizationFeature</code> in . </dd>
     * <dt>
     ...
     * <code>IDocument.setNormalizationFeature</code> in . Setting this feature 
     ...
     * to the one provided on <code>IDocument.setNormalizationFeature</code> in . </dd>
     * </dl>
    ...
    public interface IDOMBuilder
    {
         ...
         * behaviour. 
         */
        //void setErrorHandler(Action errorHandler);

        /**
         *  When the application provides a filter, the parser will call out to 
         * the filter at the completion of the construction of each 
         * <code>IElement</code> node. The filter implementation can choose to 
         ...
         * happens before the filter is called. 
         */
        //void setFilter(IDOMBuilderFilter filter);
         ...
         *   <code>IDocument</code> is returned. If the <code>DOMBuilder</code> 
         ...
         * <code>IDOMInputSource</code>.
         * @param is The <code>IDOMInputSource</code> from which the source 
         ...
         * <code>IDOMInputSource</code> and insert the content into an existing 
         ...
         * <code>IDocument</code> node, attached to the context node, is used to 
         ...
         *   is being parsed. This node must be a <code>IDocument</code> node, a 
    ...
    public enum ActionTypes
    {
         ...
         * context node must be an <code>IElement</code>, <code>Text</code>, 
         ...
         * <code>IElement</code> or a <code>DocumentFragment</code>.
         */
