...
namespace org.w3c.dom.stylesheets
{
    ...
    /**
     *  The <code>IMediaList</code> interface provides the abstraction of an 
     * ordered collection of media, without defining or constraining how this 
     * collection is implemented. An empty list is the same as a list that 
     * contains the medium <code>"all"</code>. 
     * <p> The items in the <code>IMediaList</code> are accessible via an integral 
    ...
    public interface IMediaList
    {
         ...
         *   <code>IMediaList</code>, or <code>null</code> if that is not a valid 
         *   index. 
         */
