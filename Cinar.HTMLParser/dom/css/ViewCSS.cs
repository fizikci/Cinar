...
namespace org.w3c.dom.css
{
     ...
     * instance of the <code>IAbstractView</code> interface. 
     * <p> Since a computed style is related to an <code>IElement</code> node, if 
     * this element is removed from the document, the associated 
     * <code>ICSSStyleDeclaration</code> and <code>CSSValue</code> related to 
    ...
    public interface IViewCSS : IAbstractView
    {
         ...
         * @return  The computed style. The <code>ICSSStyleDeclaration</code> is 
