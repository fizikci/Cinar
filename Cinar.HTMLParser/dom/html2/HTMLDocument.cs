...
namespace org.w3c.dom.html2
{
    ...
    /// <summary>An HTMLDocument is the root of the HTML hierarchy and holds 
    ...
    /// getElementById is inherited from the IDocument 
    ...
    public class HTMLDocument : Document
    {
        ...
        /// created with the id attribute. Note that in [<a href='http://www.w3.org/TR/2002/REC-xhtml1-20020801'>XHTML 1.0</a>], the 
        ...
        /// string that adheres to the cookie non-terminal of [<a href='http://www.ietf.org/rfc/rfc2965.txt'>IETF RFC 2965</a>]; that 
        ...
        /// elementName. In [<a href='http://www.w3.org/TR/2002/REC-xhtml1-20020801'>XHTML 1.0</a>] documents, this methods only return the 
        /// (possibly empty) collection of form controls with matching name. This 
        /// method is case sensitive. 
        /// <param name="elementName"> The name attribute value for an 
        ///   element.
