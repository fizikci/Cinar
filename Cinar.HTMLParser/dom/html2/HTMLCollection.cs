...
namespace org.w3c.dom.html2
{
    ...
    /**
     * An <code>IHTMLCollection</code> is a list of nodes. An individual node may 
    ...
    public interface IHTMLCollection
    {
         ...
         *   <code>0</code>.
         * @return The <code>INode</code> at the corresponding position upon 
        ...
        /**
         * This method retrieves a <code>INode</code> using a name. With [<a href='http://www.w3.org/TR/1999/REC-html401-19991224'>HTML 4.01</a>] 
         * documents, it first searches for a <code>INode</code> with a matching 
         * <code>id</code> attribute. If it doesn't find one, it then searches 
         * for a <code>INode</code> with a matching <code>name</code> attribute, 
         ...
         * @param name The name of the <code>INode</code> to be fetched.
         * @return The <code>INode</code> with a <code>name</code> or 
