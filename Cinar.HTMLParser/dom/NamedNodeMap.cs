...
namespace org.w3c.dom
{
    ...
    public interface INamedNodeMap
    {
         ...
         * @return A <code>INode</code> (of any type) with the specified 
         ...
         * @return If the new <code>INode</code> replaces an existing node the 
         *   replaced <code>INode</code> is returned, otherwise <code>null</code> 
         *   is returned.
         ...
         *   <code>IElement</code> object. The DOM user must explicitly clone 
         ...
         * @return A <code>INode</code> (of any type) with the specified local 
         ...
         * attribute of the <code>INode</code> interface. If so, an attribute 
