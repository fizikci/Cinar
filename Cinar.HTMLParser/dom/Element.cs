...
namespace org.w3c.dom
{
    ...
    /**
     * The <code>IElement</code> interface represents an element in an HTML or XML 
     * document. Elements may have attributes associated with them; since the 
     * <code>IElement</code> interface inherits from <code>INode</code>, the 
     * generic <code>INode</code> interface attribute <code>attributes</code> may 
     * be used to retrieve the set of all attributes for an element. There are 
     * methods on the <code>IElement</code> interface to retrieve either an 
     ...
     * <code>INode</code> interface where it was moved.
    ...
    public interface IElement : INode
    {
         ...
         *   attribute of another <code>IElement</code> object. The DOM user must 
         ...
         * a preorder traversal of this <code>IElement</code> tree.
         * @param nameThe name of the tag to match on. The special value "*" 
         *   matches all tags.
         * @return A list of matching <code>IElement</code> nodes.
         */
