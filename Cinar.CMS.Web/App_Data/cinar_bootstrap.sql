CREATE TABLE `author`(
	...
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `author` (`Id`);
...
CREATE TABLE `content`(
	...
	`Visible` bool NOT NULL DEFAULT '1',
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `content` (`Id`);
...
CREATE TABLE `lang`(
	...
	`Visible` bool NOT NULL DEFAULT '1',
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `lang` (`Id`);
...
CREATE TABLE `module`(
	...
	`CacheLifeTime` int NULL);
CREATE INDEX `PRIMARY` ON `module` (`Id`);
...
CREATE TABLE `source`(
	...
	`Visible` bool NOT NULL DEFAULT '1',
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `source` (`Id`);
...
CREATE TABLE `template`(
	...
	`Visible` bool NOT NULL DEFAULT '1',
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `template` (`Id`);
...
CREATE TABLE `user`(
	...
	`Visible` bool NOT NULL DEFAULT '1',
	`OrderNo` int NULL);
CREATE INDEX `PRIMARY` ON `user` (`Id`);
