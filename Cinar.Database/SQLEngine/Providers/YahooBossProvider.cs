...
{
    public class YahooBossProvider
    {
        private string query;

        public YahooBossProvider(string query)
        {
            this.query = query;
        }

        internal List<YahooResultItem> GetData()
        {
            string consumerKey = "dj0yJmk9RjlCNlFiYTU2WGUwJmQ9WVdrOWFXdERaVTkzTnpBbWNHbzlNVEl5TURNeE9ETTJNZy0tJnM9Y29uc3VtZXJzZWNyZXQmeD0wNw--";
            string consumerSecret = "d5a14836181b385e22630ee9bc45f9c2be3384fc";
            var uri = new Uri("http://yboss.yahooapis.com/ysearch/web?callback=json&q=" + query);
            string url, param;
            ...
            YahooSearch foo = ser.Deserialize<YahooSearch>(json);

            if (foo.responsecode == "200")
                return foo.web.results;
            else
        ...
        internal List<Hashtable> GetData(Context context, Expression where, ListSelectPart fieldNames)
        {
            ...
            foreach (YahooResultItem item in GetData())
            {
    ...
    public class YahooSearch
    {
        ...
        public YahooResult web { get; set; }
        public string responsecode { get; set; }
    }

    public class YahooResult : BaseItem
    {
        public List<YahooResultItem> results { get; set; }
        ...
        public YahooResult()
        {
            results = new List<YahooResultItem>();
        }
    }

    public class YahooResultItem : BaseItem
    {
