...
select * from INFORMATION_SCHEMA.TABLE_CONSTRAINTS where table_name='contact' AND table_catalog='db_name';
select * from INFORMATION_SCHEMA.CONSTRAINT_COLUMN_USAGE where table_name='contact' AND table_catalog='db_name';
@@
