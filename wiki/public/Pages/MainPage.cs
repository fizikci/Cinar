...
<p>Bir command pattern kütüphanesi. Uygulamanızı komutlar olarak tasarlayın. UI'de enable/disable ile yorulmayın.</p></div>
<div class="cbox">
...
<p>Kullanıcınıza sağladığınız scripting desteği ile uygulamanızın sizin bile hayal edemeyeceğiniz işlevselliğe ulaşmasını sağlayın. Artı editor, debugger ve code completion!</p></div>
<div class="cbox">
